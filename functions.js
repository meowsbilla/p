    ...
    function stickyDetailNavBar() {
        ...
        if (jQuerywindow.width() > 980) {
            if (jQuery(".detail-nav").length) {
                ...
                var AdminBarHeight_ = jQuery(".main-header").height();
...
jQuery(window).load(function() {
    ...
    if (jQuery("#singlerangeslider-Property").length > 0) {
        ...
        jQuery("#singlerangeslider-Property").on("slide", function(slideEvt) {
            jQuery("#singlerangeslider-PropertySliderVal").text(slideEvt.value.toLocaleString('en-IN'));
            calculateEMI();
        });
    }
    ...
    function calculateEMI() {
        ...
        var loanamount = jQuery('#singlerangeslider-Property').val();
        console.log("Loanamount is " + loanamount);
        var rate_of_intrest = jQuery('#singlerangeslider-annual').val();
        console.log("Rate of intrest is " + rate_of_intrest + " %");
        var tenure_in_year = jQuery('#singlerangeslider-year').val();
        console.log("Tenure " + tenure_in_year + " Year");


        //convert tenure into months
        var tenure_in_months = tenure_in_year * 12;

        var interest = rate_of_intrest / 100 / 12;

        // Now compute the monthly payment figure, using esoteric math.
        var x = Math.pow(1 + interest, tenure_in_months);
        var monthly = Math.round((loanamount * x * interest) / (x - 1));
        console.log("Your Monthly EMI " + monthly);
        //Calculate total payeble amount
        var total_payeble_amount = Math.round(monthly * tenure_in_months);

        var total_payeble_intrest = Math.round(total_payeble_amount - loanamount);
        console.log("Intrest Amount " + total_payeble_intrest);
        console.log("Total Amount Payable " + total_payeble_amount);


        document.querySelector("#montly").innerHTML = "<strong>₹" + Math.round(monthly).toLocaleString('en-IN') + "</strong>";
        document.querySelector("#total_amt_payable").innerHTML = "<strong>₹" + Math.round(total_payeble_amount).toLocaleString('en-IN') + "</strong>";
        document.querySelector("#intrest").innerHTML = "<strong>₹" + Math.round(total_payeble_intrest).toLocaleString('en-IN') + "</strong>";
        document.querySelector("#principle").innerHTML = "<strong>₹" + Math.round(loanamount).toLocaleString('en-IN') + "</strong>";

        config.data.datasets.forEach(function(dataset) {
            dataset.data = [
                loanamount,
                total_payeble_intrest,
            ];
    ...
    // For EMI Calculator END ----------------------------------------------------

    // For Elegibility Calculator start ----------------------------------------------------

    if (jQuery("#singlerangeslider-Property1").length > 0) {
        jQuery("#singlerangeslider-Property1").slider();
        jQuery("#singlerangeslider-Property1").on("slide", function(slideEvt) {
            jQuery("#singlerangeslider-PropertySliderVal1").text(slideEvt.value.toLocaleString('en-IN'));
            calculateEligibility();
        });
    }
    if (jQuery("#singlerangeslider-deposit1").length > 0) {
        jQuery("#singlerangeslider-deposit1").slider();
        jQuery("#singlerangeslider-deposit1").on("slide", function(slideEvt) {
            jQuery("#singlerangeslider-depositSliderVal1").text(slideEvt.value);
            calculateEligibility();
        });
    }
    if (jQuery("#singlerangeslider-annual1").length > 0) {
        jQuery("#singlerangeslider-annual1").slider();
        jQuery("#singlerangeslider-annual1").on("slide", function(slideEvt) {
            jQuery("#singlerangeslider-annualSliderVal1").text(slideEvt.value);
            calculateEligibility();
        });
    }
    if (jQuery("#singlerangeslider-year1").length > 0) {
        jQuery("#singlerangeslider-year1").slider();
        jQuery("#singlerangeslider-year1").on("slide", function(slideEvt) {
            jQuery("#singlerangeslider-yearSliderVal1").text(slideEvt.value);
            calculateEligibility();
        });
    }
    ...
    function calculateEligibility() {
        ...
        var grossAmount = jQuery('#singlerangeslider-Property1').val();
        
        var rateOfInterest = jQuery('#singlerangeslider-annual1').val();
        
        var tenure_in_year = jQuery('#singlerangeslider-year1').val();
        
        var otherEmi = jQuery('#singlerangeslider-deposit1').val();

        // define default loan amount we calculateEMI based on 100000 for checking elegibility
        var loanamount = 100000;
        
        //convert tenure into months
        var numberOfMonths = tenure_in_year * 12;
			...
			console.log(loan_show);
            
            
            document.querySelector("#elimontly").innerHTML = "<strong>₹" + Math.round(emiother).toLocaleString('en-IN') + "</strong>";
            //document.querySelector("#eliprinciple").innerHTML = "<strong>₹" + Math.round(loadelgamount).toLocaleString('en-IN') + "</strong>";
            //document.querySelector("#eliintrest").innerHTML = "<strong>₹" + Math.round(total_payeble_intrest).toLocaleString('en-IN') + "</strong>";
            document.querySelector("#elitotal_amt_payable").innerHTML = "<strong>₹" + Math.round(loan).toLocaleString('en-IN') + "</strong>";
    ...
    // For Elegibility Calculator End ----------------------------------------------------
